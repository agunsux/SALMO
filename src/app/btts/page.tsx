...
export default function BttsPage() {
  ...
  useEffect(() => {
    fetch('/api/matches?market=BTTS')
      ...
      .catch(err => {
        console.error('Failed to load BTTS matches:', err);
        setStatus('DATA_UNAVAILABLE');
      })
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-6 sm:px-6">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="mt-4 text-xs font-medium text-[#8A93A0]">Loading BTTS canonical intelligence...</p>
          </div>
